...
geostationary orbit \cite{RN55} . There are three categories of orbit, LEO, MEO and GEO. These are categorised by the distance the satellite orbits from the Earths surface.
...
values in order to make the solution to the position calculation more accurate. This type of system allows for sub 1m accuracy \cite{RN73} \todo{fix ref}. These systems are typically rolled out
