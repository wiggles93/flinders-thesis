...
kept via the use of caesium based atomic clocks. The GPS clocks are accurate to approximately 40 nanoseconds \cite{RN63} \cite{RN62}
\todo{fix ref}, however, receivers will lose timing due to
...
Each of the main constellations has their own unique "Talker Identifier Mnemonics" as dictated by the NMEA-0183 standard Table 7 \cite{RN109} \todo{fix ref}, which is summarised
