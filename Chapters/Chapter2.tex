...
kept via the use of caesium based atomic clocks. These clocks will de-synch by approximately 4 nanoseconds per day. \todo{reference} The value of the clocks are
constantly monitoed by the ground segment and updated when required.
Part of the Receviers (the user segment) will pick up this signal. The components of the message sent are quite simple and consist
...
are transmitted at 1.57542 GHz (L1), 1.2276 GHz (L2) or \todo{insert L5 frequency, what modulation scheme?} 
