...
II or IIA. This totals 31 opeartional satellites, 24 in opeartion and 7 spares as summarised in \ref{tab:GPSSatSum}

Each iteration of block has added functionality and each major block revision has increased the life expectancy of the hardware.

\todo{insert table of block type and number of satellites inn service}
