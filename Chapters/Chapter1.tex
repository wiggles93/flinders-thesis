...
ever advancing technology an EW chair was devised. This project was the first completed in conjunction with. GNSS technology provides critical information for
...
methodology and to create hardware capable of performing a spoofing attack. This will be used to create a baseline for SDR capabilities research from within Flinders University where future research can build upon this initial documentation.
