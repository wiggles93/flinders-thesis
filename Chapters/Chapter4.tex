...
Below is the implementation of the law of haversines in python used for the calcualtion of distance between two latitude and longitude points. The output of the function was stored
