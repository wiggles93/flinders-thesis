...
GPS-SDR-sim compiles the signals into a 16bit data format where the first 8bits represents the Interphase data and the next 8 bits represents the Quadrature data information.
