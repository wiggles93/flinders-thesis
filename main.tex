...
\begin{abstract}
  \addchaptertocentry{\abstractname} % Add the abstract to the table of contents
	...
	compatibility can leave them susceptible to an attack.
	While GNSS constellations as a whole may have been technologically advanced compared to civilian technology when launched, that
...
I wish to thank all those that have supported me through not only my thesis, but my entire degree. In particular Saeed, who guided me through the process of an
Honours Thesis. \\ My parents have always been supportive of my decisions and I could not have made it this far without them. To everyone who has had to listen to
my endless ramblings about whatever it was I was working on at the time, thank you.
\\
\\
Most importantly 
I'd like to thank Jacqueline
Miller for her patience with me through the early years of my degree. Her kindness, composure with me and grammatical help have guided me to where I am today. 
...
\textbf{CBD} & \textbf{C}entral \textbf{B}usiness \textbf{D}istrict \\
...
\textbf{IRNSS} & \textbf{I}ndian \textbf{R}egional \textbf{N}avigation \textbf{S}atellite \textbf{S}ystem\\
\textbf{LEO} & \textbf{L}ow \textbf{E}arth \textbf{O}rbit\\
\textbf{LNA} & \textbf{L}ow \textbf{N}oise \textbf{A}mplifier \\
\textbf{CBD} & \textbf{M}ass \textbf{A}ssembly \textbf{B}uilding \\
...
\textbf{PRN} & \textbf{P}seudo \textbf{R}andom \textbf{N}umber\\
...
\textbf{VLF} & \textbf{V}ery \textbf{L}ow \textbf{F}requency \\
