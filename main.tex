...
\begin{abstract}
  \addchaptertocentry{\abstractname} % Add the abstract to the table of contents
	As GNSS (Global Navigation Satellite System) technology becomes more and more prevalent in society more needs to be done to ensure that it remains a robust system. There is a distinct issue with
