...
\thesistitle{Local GPS Spoofing using Software Defined Radio} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\degree{Bachelour of Engineering(Electrical)(Honours)} % Your degree name, this is used in the title page and abstract, print it elsewhere with \degreename
\author{Alastair Wiegelmann} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
